-- Remove ambiguous overloads and force explicit POST RPC with one required parameter.

DROP FUNCTION IF EXISTS public.bank_embedding_claim_batch();
DROP FUNCTION IF EXISTS public.bank_embedding_claim_batch(integer);

CREATE FUNCTION public.bank_embedding_claim_batch(
